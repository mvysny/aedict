 ...
 */
public
class StringTokens implements Enumeration<Object> {
     ...
     */
    public StringTokens(String str, String delim, boolean returnDelims) {
        currentPosition = 0;
        newPosition = -1;
        delimsChanged = false;
        this.str = str;
     ...
     * @exception NullPointerException if str is <CODE>null</CODE>
     */
    public StringTokens(String str, String delim) {
