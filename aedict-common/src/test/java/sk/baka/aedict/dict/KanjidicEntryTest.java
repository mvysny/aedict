...
public class KanjidicEntryTest {
    ...
    private KanjidicEntry test3() {
        return new KanjidicEntry("方", "ホ ウ, か た, -か た, -がた", "a to b, foo bar baz", 1, 2, "3-4-5", 6);
    }
    @Test
    public void testEnglish() {
        ...
        assertArrayEquals(test3().getEnglish(), Arrays.asList("a to b", "foo bar baz"));
    }
    ...
    public void testOnyomi() {
        ...
        assertArrayEquals(test3().getOnyomi(), Arrays.asList("ホ ウ"));
    }
    ...
    public void testKunyomi() {
        ...
        assertArrayEquals(test3().getKunyomi(), Arrays.asList("か た", "-か た", "-がた"));
    }
    ...
    public void testNamae() {
        ...
        assertArrayEquals(test3().getNamae(), Arrays.asList());
    }
